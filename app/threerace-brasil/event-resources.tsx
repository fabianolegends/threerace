...
const regulationPath = "/brasil-2027/regulamento-threerace-2027-revisao-01.pdf";
  ...
  return <div className="brasil-panel-extra">
    <div className="brasil-regulation-card">
      ...
      <div className="brasil-regulation-details">
        ...
        <p>Revisão 01 · 21 de setembro de 2026</p>
        <div className="brasil-resource-actions">
          ...
          <a className="brasil-resource-download" href={regulationPath} download="regulamento-threerace-2027-revisao-01.pdf">BAIXAR PDF <span aria-hidden="true">↓</span></a>
        </div>
      </div>
    </div>
  </div>;
