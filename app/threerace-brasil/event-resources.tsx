  ...
  return <div className="brasil-panel-extra">
    <div className="brasil-regulation-card">
      ...
      <div className="brasil-regulation-details">
        <span className="brasil-resource-label">PDF EM REVISÃO · 15 PÁGINAS</span>
        <h5>Regulamento Threerace Brasil 2027</h5>
        <p>Revisão 08 · 22 de setembro de 2026</p>
        <div className="brasil-resource-actions">
          ...
          <a className="brasil-resource-download" href={regulationPath} download="regulamento-threerace-2027-revisao-08.pdf">BAIXAR PDF <span aria-hidden="true">↓</span></a>
        </div>
      </div>
    </div>
    <p className="brasil-regulation-review"><strong>Revisão da equipe:</strong> o PDF ainda precisa refletir a sacochila incluída no kit e a regra de 75% para a medalha FINISHER. Falta definir se esse percentual considera distância ou etapas; o documento atual ainda exige concluir todas as etapas válidas.</p>
  </div>;
}
