...
- **Regulamento Brasil 2027, revisão 07**: itens 7.6 (orientações também disponíveis à Sport no sábado), 11 (etapa de XCC em baterias por categoria), 12 (alinhamento e largadas por modalidade), 18 (premiações).
